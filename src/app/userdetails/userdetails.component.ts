...
export class UserdetailsComponent {
  ...
  // Arrays containing profiles and companies information
  profiles: string[] = [
  ...
  // Constructor to inject ActivatedRoute and UserService dependencies
  constructor(
  ...
  ngOnInit(): void {
    ...
    this.route.params.subscribe((params) => {
      // Extract and convert 'userId' from route parameters
  ...
  // Method to fetch user details using the UserService
  getUserDetails(): void {
    // Call the UserService to get user details based on userId
    this.userService.getUserById(this.userId).subscribe((user) => {
      // Assign the fetched user details to the 'user' property
      this.user = user;
    });
  }
}
